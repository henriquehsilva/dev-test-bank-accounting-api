...
Devise.setup do |config|
  ...
  # config.secret_key = '57047c921885c488f69ee8b6604ddef0233a2886fc40' +
  #                     'fe2f24f483872472665de0937cd0ccbf72657a054efe' +
  #                     'be9b404f9545f5e9f6cc3fe5da94c3043230731c'
  ...
  config.mailer_sender = 'please-change-me-at' \
  ...
  # config.pepper = '1743396d1cdb95e2b50e800d425cf166a5397721ce' +
  #                 'f851e038bf3092c276774113de34e4924b96b8843d' +
  #                 'a48279e035152e854121570f8f0b89e31daa19726727'
  ...
  # (default).
  # You can use :sha1, :sha512 or algorithms from others authentication
  # tools as
  # :clearance_sha1, :authlogic_sha512 (then you should set stretches
  # above to 20
  # for default behavior) and :restful_authentication_sha1 (then you
